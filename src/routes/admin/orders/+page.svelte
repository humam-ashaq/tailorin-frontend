      ...
      {#each incomingRequests as req}
        ...
        >
          ...
          <div class="flex justify-between items-start mb-4 pl-2">
            ...
            <div
              class="p-2 bg-gray-100 text-gray-500 rounded-lg"
              title="Menunggu Penentuan Harga"
            >
              <AlertCircle size={20} />
            </div>
          </div>
    ...
    >
          ...
          <tbody class="divide-y divide-gray-50">
            {#each activeOrders as order}
              <tr class="hover:bg-gray-50 transition group">
                ...
                <td class="px-6 py-4">
                  <span
                    class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide {statusColor(
                      order.status
                    )}"
                  >
                    {order.status}
      ...
      >
        <span class="text-xs text-gray-500"
          >Menampilkan 1-3 dari 12 pesanan</span
        >
